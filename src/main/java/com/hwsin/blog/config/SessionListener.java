...
public class SessionListener implements HttpSessionListener {
	...
	public void sessionCreated(HttpSessionEvent sessionEvent) {
		...
		// 전체 방문자 수 증가
		visitService.setVisitTotalCount(ip);
		// log
		System.out.println(" Session ID ".concat(sessionEvent.getSession().getId()).concat(" created at ")
