...
<div class="container row orderContainer">
	...
	<div class="col">
		...
		<img src="${product.filePath}" style="max-width: 100%; height: auto;" alt="" /> <input type="hidden" id="userName" value="${product.user.username}">
	...
	<div class="col">
		<div class="form-group orderForm">
			...
			<div class="row" style="margin-right: 0px; margin-left: 0px;">
				<input class="form-control col" type="text" id="roadAddress" placeholder="도로명주소"> <input class="form-control col" type="text" id="jibunAddress" placeholder="지번주소">
			</div>
			<span id="guide" style="color: #999; display: none"></span> <input class="form-control" type="text" id="detailAddress" placeholder="상세주소"> <input class="form-control" type="text"
			...
			<div class="row" style="margin-right: 0px; margin-left: 0px;">
				...
				<input type="text" class="form-control col mr-3" id="buyerTel3" maxlength="4" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
			</div>
			...
			<input  type="text" class="form-control" value="${product.prodKrw}" id="prodKrw" readonly>
		</div>
	</div>
	...
	<h6>결제 안내</h6>
		<c:choose>
			<c:when test="${product.qty != 0}">
				<button id="card" class="btn btn-outline-primary mb-1" onclick="payment(this)">신용카드 결제</button>
				<button id="phone" class="btn btn-outline-primary mb-1" onclick="payment(this)">휴대폰 결제</button>
				<button id="vbank" class="btn btn-outline-primary" onclick="payment(this)">가상계좌 결제</button>
				<button id="trans" class="btn btn-outline-primary" onclick="payment(this)">실시간계좌이체</button>
			</c:when>
			<c:when test="${product.qty == 0}">
